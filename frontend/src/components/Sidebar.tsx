      ...
      >
        <div className="p-8 border-b border-primary-hover flex items-center justify-between bg-primary-hover/20">
          <div className="flex flex-col gap-1">
            <h1 className="text-xl font-extrabold tracking-wider text-white">HOTEL HUB</h1>
            <div className="flex items-center gap-2">
               <span className="text-[10px] uppercase tracking-widest text-primary-light opacity-70">Premium</span>
               <div className="flex gap-0.5">
                  {[1,2,3,4,5].map(s => <Star key={s} className="w-2 h-2 text-secondary" fill="currentColor" />)}
               </div>
            </div>
          </div>
          <button onClick={closeSidebar} className="md:hidden text-primary-light hover:text-white cursor-pointer">
            <X className="w-6 h-6" />
          </button>
        </div>
        ...
        <div className="p-6 border-t border-primary-hover bg-primary-hover/30">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div className="flex-1 overflow-hidden">
              ...
              <p className="text-xs text-primary-light opacity-80">Administrador</p>
            </div>
          </div>
