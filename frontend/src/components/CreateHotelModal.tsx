...
export const CreateHotelModal: React.FC<CreateHotelModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white w-full max-w-2xl rounded-xl shadow-2xl max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in duration-200">
        ...
        <div className="p-6">
          ...
          <div className="border-t border-gray-100 flex flex-col md:flex-row items-center justify-center gap-4">
            <button
              type="button"
              onClick={onClose}
              className="flex items-center justify-center px-6 py-3 rounded-lg border border-gray-300 
                         ...
                         cursor-pointer whitespace-nowrap w-full md:min-w-[140px] order-2 md:order-1"
            >
              Cancelar
            </button>
            ...
            <Button
              ...
              disabled={loading}
              className="w-full md:min-w-[140px] order-1 md:order-2"
            >
